...
//	}
	 ...
	 * @return
	 */
	public static Date getLongToDate(long time, String format){
		Date date = new Date(time);
		return convertDate(dateToDateString(date, format));
	}
...
//	}
	 ...
	 * @return
	 */
	public static Long getTheDayBeforeYestodayBeginTime(){
		Calendar cal = Calendar.getInstance();
		cal.setTime(new Date());
		cal.set(Calendar.HOUR_OF_DAY, 0);
		cal.set(Calendar.MINUTE, 0);
	 ...
	 * @return
	 */
	public static Long getTheDayBeforeYestodayEndTime(){
		Calendar cal = Calendar.getInstance();
		cal.set(Calendar.HOUR_OF_DAY, 23);
		cal.set(Calendar.MINUTE, 59);
		cal.set(Calendar.SECOND, 59);
	...
	// 获得下周一开始时间
	public static Long getNextWeekBeginTime() {
		Calendar cal = Calendar.getInstance();
		cal.setTime(new Date(getThisWeekBeginTime()));
	 ...
	 * @return
	 */
	public static Long getLastMonthBeginTime(){
		Calendar cal = Calendar.getInstance();
		cal.setTime(new Date());
		cal.add(Calendar.MONTH, -1);
		cal.set(Calendar.DAY_OF_MONTH,1);//设置为1号,当前日期既为本月第一天
	...
	//获取一周的第几天  cal.get(Calendar.DAY_OF_WEEK)返回值：1=Sunday,2=Monday,,,7=Saturday。
	...
	public static int getMonthOfYear(Date date){
		...
		try {
			cal.setTime(format.parse(dateToDateString(date)));
		} catch (ParseException e) {
			e.printStackTrace();
		}
...
//		System.out.println(getLongToStr(getTodayBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getTodayEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getYestodayBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getYestodayEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getTheDayBeforeYestodayBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getTheDayBeforeYestodayEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisWeekBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getNextWeekBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisWeekEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisMonthBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisMonthEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getLastMonthBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getLastMonthEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisYearBeginTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getThisYearEndTime(), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(DateUtil.convertDate(DateUtil.getLongToStr(1526832000000L, DateUtil.yyyy_MM_dd_EN)));
...
//		System.out.println(getLongToStr(getYearBeginTime(2017), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getYearEndTime(2017), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getMonthBeginTime(2017,5), yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getLongToStr(getMonthEndTime(2017,5),yyyy_MM_dd_HH_mm_ss_EN));
//		System.out.println(getNowDay());
		System.out.println(getTotalDayOfMonth(2018,2));
		System.out.println(getCurrentTime());
		System.out.println(getCurDate(yyyy_MM_dd_HH_mm_ss_EN));
	}
