...
public class Sha1Util {
	...
	private static String key = "2rza08oavkfamfyahw9agt6s9epc1uckcsjcocltve";
	...
	// 创建签名SHA1
	public static String createSHA1SignWithKey(SortedMap<String, String> signParams)
			throws Exception {
	...
	// 创建签名SHA1
	public static String createSHA1(SortedMap<Object, Object> signParams)
			throws Exception {
		StringBuffer sb = new StringBuffer();
		Set es = signParams.entrySet();
		Iterator it = es.iterator();
